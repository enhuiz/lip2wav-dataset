"""
This script is from https://github.com/Rudrabha/Lip2Wav/blob/95d923f130e4cce93fdffbf67d2ec2d66eef933a/synthesizer/audio.py for spectrogram calculation.
"""
...
def inv_mel_spectrogram(mel_spectrogram, hparams):
    ...
    S = _mel_to_linear(
        _db_to_amp(D + hparams.ref_level_db), hparams
...
def _lws_processor(hparams):
    ...
    return lws.lws(
        hparams.n_fft, get_hop_size(hparams), fftsize=hparams.win_size, mode="speech"
    )
...
def _istft(y, hparams):
    return librosa.istft(
        y, hop_length=get_hop_size(hparams), win_length=hparams.win_size
    )
